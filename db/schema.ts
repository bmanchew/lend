...
export const merchants = pgTable("merchants", {
  ...
  reserveBalance: decimal("reserve_balance", {
    precision: 10,
    scale: 2,
  }).default("0"),
...
export type UnderwritingStatus =
  (typeof UnderwritingStatus)[keyof typeof UnderwritingStatus];
...
export const contracts = pgTable("contracts", {
  ...
  notes: text("notes"),
  underwritingStatus: varchar("underwriting_status", { length: 50 }).default(
    "pending",
  ),
...
// Relations exports
export const rewardsBalancesRelations = relations(
  rewardsBalances,
  ({ one }) => ({
    user: one(users, {
...
export const rewardsTransactionsRelations = relations(
  rewardsTransactions,
  ({ one }) => ({
    user: one(users, {
...
export const rewardsRedemptionsRelations = relations(
  rewardsRedemptions,
  ({ one }) => ({
    user: one(users, {
